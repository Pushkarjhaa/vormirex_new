...
import 'package:vormirex_new/view/onboarding_third_screen.dart';
                ...
                child: Container(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      Image.asset("assets/onboarding_second_image.png"),
                    ],
                  ),
                ),
              ),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () { Get.to(OnboardingThirdScreen()); },
...
class _StudentFigure extends StatelessWidget {
  @override
  Widget build(BuildContext context) => SizedBox(width: 90, height: 160, child: CustomPaint(painter: _StudentPainter()));
}
...
class _AIFigure extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => SizedBox(width: 80, height: 170, child: CustomPaint(painter: _AIPainter(accentCyan: accentCyan)));
}
...
class _AIPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final glowPaint = Paint()..style = PaintingStyle.fill..maskFilter = const MaskFilter.blur(BlurStyle.normal, 10);
    ...
    paint.color = const Color(0xFF6B5CE7);
    final path = Path()..moveTo(68, 100)..lineTo(80, 75)..lineTo(75, 72)..lineTo(62, 95)..close();
...
class _FloatingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 85, height: 90,
      decoration: BoxDecoration(color: const Color(0xFF2E2E3E), borderRadius: BorderRadius.circular(10), border: Border.all(color: accentCyan.withOpacity(0.25), width: 1)),
...
class _LaptopWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      Container(
        width: 130, height: 80,
        decoration: BoxDecoration(color: const Color(0xFF1E1E2E), borderRadius: const BorderRadius.only(topLeft: Radius.circular(6), topRight: Radius.circular(6)), border: Border.all(color: Colors.white12, width: 1.5)),
      ...
      Container(width: 150, height: 8, decoration: const BoxDecoration(color: Color(0xFF3A3A4A), borderRadius: BorderRadius.only(bottomLeft: Radius.circular(4), bottomRight: Radius.circular(4)))),
    ]);
  }
  Widget _dot(Color c) => Container(width: 6, height: 6, margin: const EdgeInsets.only(right: 3), decoration: BoxDecoration(color: c, shape: BoxShape.circle));
}
